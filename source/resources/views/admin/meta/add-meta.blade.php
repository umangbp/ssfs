	            	...
	            	<div class="box-body pad">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
							    	...
							    	{{ Form::text('page_name','',['class' => 'form-control', 'placeholder' => 'Please Enter Page Name']) }}
									<div class="err-block">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group"> 	
							    	...
							    	{{ Form::text('meta_title','',['class' => 'form-control', 'placeholder' => 'Please Enter Meta Title']) }}
						...
						<div class="row">
							<div class="col-md-6">
								...
								{{ Form::textarea('meta_description','',['class' => 'form-control', 'placeholder' => 'Please Enter Meta Description']) }}	
						...
						<div class="row">
							<div class="col-md-6">
								...
								{{ Form::textarea('meta_keywords','',['class' => 'form-control', 'placeholder' => 'Please Enter Meta Keywords']) }}	
